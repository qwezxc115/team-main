...
#lgbtn {
	width: 100%;
	background: linear-gradient(to right, lightCyan, skyBlue, deepSkyBlue);
	font-weight: 550;
}
		...
		<div class="jumbotron" style="background-color: #fff;">
			...
			<div class="text-center p-5">
				<a href="${appRoot }/main/home">
					<img alt="gotriple" width="100"
						src="${appRoot }/resources/img/triple.png">
				</a>
			</div>
			...
			<div class="row justify-content-center ">
				<form class="col-5" action="${appRoot }/login" method="post">
					<div class="form-group">
						...
						<input id="idinput" class="form-control" name="username"
							placeholder="아이디 " />
					</div>
			...
			<div class="row justify-content-center text-center m-2">
				<div class="col-2">
					<a href="${appRoot }/main/findId" target="_blank"> 아이디찾기 </a>
				</div>
				<div class="col-2">
					<a href="${appRoot }/main/findPw" target="_blank"> 비밀번호찾기 </a>
				</div>
				<div class="col-2">
					<a href="${appRoot }/member/signup"> 회원가입 </a>
				</div>
			</div>
		</div>
	</div>
